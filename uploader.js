...
var CLIENT_ID     = process.env.CLIENT_ID || "bUA1koQ2jXcz66qKOWGCzEAOKWPOyDb2",
	CLIENT_SECRET = process.env.CLIENT_SECRET || "M510e35bf95184af",
	BUCKET_KEY    = process.env.BUCKET_KEY || "grit_hackathon" + CLIENT_ID.toLowerCase(),
	FILE_NAME     = "160765-000-MASTER_STRUCT_detached.rvt",
	FILE_PATH     = "./models/160765-000-MASTER_STRUCT_detached.rvt";
 ...
 */
 module.exports = {
	 distUpload : function(FILE_NAME, FILE_PATH) {
